...
__DEFINE__(1647163052931, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647163052932,"./event-store":1647163052933}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647163052932, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647163052933, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647163052932,"./utils":1647163052934}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647163052934, function(require, module, exports) {
...
return __REQUIRE__(1647163052931);
})()
