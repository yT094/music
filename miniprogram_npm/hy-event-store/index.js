...
__DEFINE__(1647326532289, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647326532290,"./event-store":1647326532291}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647326532290, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647326532291, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647326532290,"./utils":1647326532292}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647326532292, function(require, module, exports) {
...
return __REQUIRE__(1647326532289);
})()
